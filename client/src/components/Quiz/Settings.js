...
function Settings() {
  ...
  if (!loading) {
    return (
      <div>
        <h1 style={{fontWeight: '600', fontSize: '40px'}}><u>Quick Quiz</u></h1>
        <div>
          <h2>Select Category:</h2>
          <select value={questionCategory} onChange={handleCategoryChange} style={{borderRadius: '10px'}}>
            <options>All</options>
            {options &&
              options.length &&
              options.map((option) => (
        ...
        <div>
          ...
          <select value={questionDifficulty} onChange={handleDifficultyChange} style={{borderRadius: '10px'}}>
        ...
        <div>
          ...
          <select value={questionType} onChange={handleTypeChange} style={{borderRadius: '10px'}}>
        ...
        <div>
          ...
          <input value={questionAmount} onChange={handleAmountChange} style={{borderRadius: '10px'}}/>
        </div>
